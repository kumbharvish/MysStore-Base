...
public class CustomerHistoryServices {
	...
	private static final String GET_ALL_CUST_BILLS = "SELECT CBD.*,CD.CUST_NAME AS CUSTOMER_NAME,SD.NAME AS SALESMAN_NAME FROM CUSTOMER_BILL_DETAILS CBD,CUSTOMER_DETAILS CD,SALESMAN_DETAILS SD WHERE CBD.CUST_MOB_NO=? AND CBD.CUST_MOB_NO=CD.CUST_MOB_NO AND CBD.SALESMAN_MOB_NO=SD.MOBILE_NUMBER ORDER BY BILL_DATE_TIME DESC";

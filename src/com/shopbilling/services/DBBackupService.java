...
public class DBBackupService {
	...
	public static void createDBDump() {
	    try {
	        ...
	        String executeCmd = mySqlHome+"\\\\bin\\\\mysqldump -u root -ppassword billing_app_omelec -r "+folderLocation+fileName;
	...
	public static void importDBDump(String fileLocation) {
	    try {
	        ...
	        String executeCmd = mySqlHome+"\\bin\\mysql -u root -ppassword billing_app_omelec "+finalFileLocation;
